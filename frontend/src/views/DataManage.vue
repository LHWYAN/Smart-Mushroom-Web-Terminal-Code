<template>
  <div>
    ...
    <p class="page-title-desc">查询、录入与清理传感器历史采集数据</p>
    ...
    <el-dialog v-model="visible" title="手动插入数据" width="480px">
      <el-form label-width="70px">
        ...
        <el-row :gutter="12">
          ...
          <el-col :span="12"><el-form-item label="照明">
            <el-select v-model="form.LampST" style="width:100%"><el-option label="OFF" value="OFF" /><el-option label="ON" value="ON" /></el-select>
          </el-form-item></el-col>
        </el-row>
      </el-form>
      <template #footer>
...
async function batchDelete() {
  const device_id = prompt('按设备 ID 批量删除（留空不限）')
